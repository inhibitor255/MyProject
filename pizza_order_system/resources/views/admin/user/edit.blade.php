                ...
                <div class="col-lg-10 offset-1">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('admin#userEdit') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class=" col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name"
                                                ...
                                                placeholder="Enter Admin Name" value="{{ old('name', $user->name) }}">
                                            @error('name')
                                                <span class="text-danger sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email"
                                                ...
                                                placeholder="Enter Admin Email" value="{{ old('email', $user->email) }}">
                                            @error('email')
                                                <span class="text-danger sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" id="phone"
                                                ...
                                                placeholder="Enter Admin Phone" value="{{ old('phone', $user->phone) }}">
                                            @error('phone')
                                                <span class="text-danger sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" cols="10" rows="3"
                                                class="form-control @error('address') is-invalid @enderror" placeholder="Enter Admin Address">{{ old('address', $user->address) }}</textarea>
                                            @error('address')
                                                <span class="text-danger sm">{{ $message }}</span>
                                            @enderror
                                        </div>
